...
QDialog(parent),
  m_urlString3(QString("https://github.com/LeopoldG")),
m_urlString(QString("https://colinbourassa.github.io/car_stuff/mems_interface/")),
m_urlLibString(QString("https://github.com/colinbourassa/librosco")),
m_urlString2(QString("https://github.com/haro78/MEMS-Scan")),
m_urlString4(QString("https://rmrsoft.com/mems/index.htm")),
  m_urlString5(QString("https://groups.google.com/forum/#!forum/mems-diagnostics")),
m_aboutString(QString("A graphical interface to the Rover Modular Engine Management System 1.3 and 1.6.   "))
{
...
//  defaultFont.setPointSize(14);
 // m_name->setFont(defaultFont);
  ...
  m_url = new QLabel("Based on <a href=\"" + m_urlString + "\">" + "MEMS Gauge by Collin Bourassa" + "</a>" , this);
  m_url->setOpenExternalLinks(true);

  m_url2 = new QLabel("An other tool for analysing log files: <a href=\"" + m_urlString4 + "\">" + "MEMSAnalyser" + "</a>", this);
  m_url2->setOpenExternalLinks(true);

  m_urlLib = new QLabel("An other scantool <a href=\"" + m_urlString2 + "\">" + "MEMS-scan by Haro" + "</a>", this);
  m_urlLib->setOpenExternalLinks(true);

  m_urlDownload = new QLabel("For updates, feedback, etc.: <a href=\"" + m_urlString3 + "\">" + "MEMS-rosco" + "</a>", this);
  m_urlDownload->setOpenExternalLinks(true);

  m_urlForum = new QLabel("For discussion and feedback, etc.: <a href=\"" + m_urlString5 + "\">" + "Forum" + "</a>", this);
  m_urlForum->setOpenExternalLinks(true);
  ...
  m_grid->addWidget(m_urlForum, 7, 1, 1, 1, Qt::AlignLeft);
